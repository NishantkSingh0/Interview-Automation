    ...
    <div className="relative space-y-2">
      ...
      {isTextArea ? (
        <textarea
          ...
          className="w-full h-56 sm:h-48 md:h-44 lg:h-30 px-3 py-2 border rounded resize-none peer focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:text-white dark:border-gray-600"
          value={inputValue}
